...
// welcome.us
(function() {
  var backButtonForPanel, bindFormKeyup, completeFormReset, disableDownloadLink, enableDownloadLink, getTrimmedValue, hideIntroPanel, hideResetButton, initAcceptAltImg, initAltYearLinks, initAltYearPreview, initBackButton, initDownloadLinks, initHideIntroPanel, initResetAltYearPreview, initShowHideIntro, initYearFormField, registerGAevent, showDecadePreview, showErrorMessage, showEstPreview, showIntroPanel, showResetButton, showRightSubpanel, showYearForm, updateDownloadLink, useJqAnimate, validateYearInput, validateYearRange, valueIsInteger, yearFieldFocus;

  $(function() {
    useJqAnimate();
    initShowHideIntro();
    return initDownloadLinks();
  });
