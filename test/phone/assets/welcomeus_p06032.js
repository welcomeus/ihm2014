...
(function() {
  var bindFormKeyup, completeFormReset, disableDownloadLinks, enableDownloadLinks, getTrimmedValue, initAltYearLinks, initAltYearPreview, initDownloadLinks, initResetAltYearPreview, registerGAevent, showDecadePreview, showErrorMessage, showEstPreview, updateDownloadLink, updateYearInputField, validateYearInput, validateYearRange, valueIsInteger;
  ...
  initAltYearPreview = function() {
    return $('#cu_alt_year_links .alt-img').fastClick(function() {
      var content;
      $('#cu_alt_year_links span').removeClass('selected');
