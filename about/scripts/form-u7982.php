...
function emailFormSubmission()
{
	...
	$subject = 'Welcome.us Tablet Join Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U7992"],ENT_COMPAT,'UTF-8') . '</td></tr>';
