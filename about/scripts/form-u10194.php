...
{
	$to = 'welcome.41kao@zapiermail.com';
	$subject = 'Welcome.us Join Desktop Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U10209"],ENT_COMPAT,'UTF-8') . '</td></tr>';
