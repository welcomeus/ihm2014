...
{
	$to = 'info@welcome.us,marcus@vibrancystudios.com';
	$subject = 'Welcome.us Mobile Get Involved Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U1681"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U1673"],ENT_COMPAT,'UTF-8') . '</td></tr>';
