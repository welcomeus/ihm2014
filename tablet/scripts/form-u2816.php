...
{
	$to = 'welcome.41kao@zapiermail.com,info@welcome.us,marcus@vibrancystudios.com';
	$subject = 'Welcome.us Desktop Get Involved Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U2823"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U2817"],ENT_COMPAT,'UTF-8') . '</td></tr>';
