...
{
	$to = 'info@welcome.us';
	$subject = 'Welcome.us Desktop Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U2185"],ENT_COMPAT,'UTF-8') . '</td></tr>';
